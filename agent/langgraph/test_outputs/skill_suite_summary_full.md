...
|---:|---|---|---|---|---|
| 1 | login | SKILL_EXECUTION_FAILED | login,get_courses,get_notices,show_summary | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
| 2 | refresh_session | SKILL_EXECUTION_FAILED | refresh_session | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
| 3 | logout | SKILL_EXECUTION_FAILED | login,logout | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
...
| 10 | get_academic_calendar | SKILL_EXECUTION_FAILED | get_academic_calendar,create_calendar_event | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
...
| 13 | create_reminder | SKILL_EXECUTION_FAILED | get_courses,get_assignments,show_summary,create_reminder | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
| 14 | create_calendar_event | SKILL_EXECUTION_FAILED | get_courses,get_assignments,show_summary,create_calendar_event | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
...
| 17 | send_notification | SKILL_EXECUTION_FAILED | create_reminder,send_notification | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |
...
| 19 | launch_app | SKILL_EXECUTION_FAILED | launch_app | - | normalize_requirement,plan_skills,safety_check,execute_skills,replan_failed,audit_record,memory_update |